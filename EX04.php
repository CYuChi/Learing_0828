...
<?php
    $rate_list = array(
        array(
            "name"=>"美金","id"=>"USD","rate"=>28.95),
        array(
            "name"=>"港幣","id"=>"HKD","rate"=>3.631),
        array(
            "name"=>"英鎊","id"=>"GBP","rate"=>37.76),
        array(
            "name"=>"澳幣","id"=>"AUD","rate"=>21.07),
        array(
            "name"=>"加拿大幣","id"=>"CAD","rate"=>21.94),
        array(
            "name"=>"新加坡幣","id"=>"SGD","rate"=>20.97)
        );
?>
